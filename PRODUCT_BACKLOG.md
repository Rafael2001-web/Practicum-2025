# 📋 PRODUCT BACKLOG - SISTEMA DE GESTIÓN PRACTICUM 2025
...
|-----------|----------------------------|---------------|----------------|-----------------|------------|------------|
| **HU-01** | Se crean usuarios, se definen roles preestablecidos (admin, técnico, revisor, etc.). Cada usuario solo accede a los módulos habilitados por su rol. Se registra la fecha de asignación o cambio de rol. | 1 | 5 | - | 1 | Por Hacer |
| **HU-02** | El sistema permite registrar todos los campos definidos. Se valida que el código no esté duplicado. El estado inicial debe ser "Activo". | 1 | 4 | - | 1 | Por Hacer |
| **HU-03** | Se pueden actualizar todos los campos excepto el código. Se registra fecha de modificación. Solo entidades activas pueden ser editadas. | 2 | 3 | HU-02 | 1 | Por Hacer |
| **HU-04** | Solo entidades activas pueden ser desactivadas y viceversa. Se guarda un historial de cambios de estado. | 3 | 3 | HU-03 | 1 | Por Hacer |
| **HU-05** | Se permite registrar macro sectores y sectores asociados. Cada unidad debe estar asociada a una entidad activa. El sistema debe permitir estructura en árbol. | 1 | 4 | HU-04 | 1 | Por Hacer |
...
| **ID HU** | **Criterios de Aceptación** | **Prioridad** | **Estimación** | **Dependencia** | **Sprint** | **Estado** |
|-----------|----------------------------|---------------|----------------|-----------------|------------|------------|
| **HU-09** | Permitir registrar un nuevo plan institucional. Guardar historial de versiones con metadatos. Visualización de diferencias entre versiones. | 2 | 3 | - | 2 | Por Hacer |
| **HU-10** | CRUD completo de planes. Validaciones de integridad. Estados del plan (borrador, activo, archivado). | 1 | 5 | HU-09 | 3 | Por Hacer |
| **HU-11** | Definir cronogramas con hitos. Vincular con objetivos estratégicos. Dashboard de seguimiento. | 2 | 4 | HU-10 | 3 | Por Hacer |

### **EPIC-04: Validación y Cumplimiento Normativo**

| **ID HU** | **Criterios de Aceptación** | **Prioridad** | **Estimación** | **Dependencia** | **Sprint** | **Estado** |
|-----------|----------------------------|---------------|----------------|-----------------|------------|------------|
| **HU-12** | El sistema debe verificar alineación con PND y ODS. Mostrar alertas y recomendaciones. Generar reportes de cumplimiento. | 2 | 4 | HU-10 | 4 | Por Hacer |
| **HU-13** | Validaciones automáticas en tiempo real. Indicadores de conformidad visual. Exportación de reportes de validación. | 1 | 5 | HU-12 | 4 | Por Hacer |
| **HU-14** | Sistema de notificaciones configurable. Alertas por email y en dashboard. Historial de notificaciones. | 3 | 3 | HU-13 | 4 | Por Hacer |
