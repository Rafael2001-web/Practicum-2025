...
<x-modal name="delete-pnd-modal" maxWidth="md">
    <div class="p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <button onclick="closeModal('delete-pnd-modal')"
        ...
        <div class="mb-6">
            ...
            <div class="text-center">
                ...
                <p class="text-sm text-neutral">
                    El objetivo PND "<span id="delete-pnd-name" class="font-semibold"></span>" será eliminado permanentemente. Esta acción no se puede deshacer.
                </p>
            </div>
        </div>
        
        <div class="flex justify-end space-x-3">
            <x-secondary-button type="button" onclick="closeModal('delete-pnd-modal')">
                Cancelar
            </x-secondary-button>
