        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Aquí irían otros nav-links normales si los hubiera -->
                </div>
            </div>

            <!-- Navigation Dropdowns (ubicados como el Settings dropdown) -->
            <div class="hidden sm:flex sm:items-center sm:space-x-4">
                ...
                @canany(['view entidades', 'manage entidades', 'view unidades', 'manage unidades'])
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white hover:text-gray-200 focus:outline-none transition ease-in-out duration-150 {{ request()->routeIs(['entidades.*', 'unidades.*']) ? 'text-yellow-300' : '' }}">
                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @canany(['view planes', 'manage planes', 'view pnd', 'manage pnd', 'view objetivos_estrategicos', 'manage objetivos_estrategicos', 'view ods', 'manage ods'])
                    <x-dropdown align="left" width="56">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-primary hover:text-gray-200 focus:outline-none transition ease-in-out duration-150">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                                </svg>
                                <div>{{ __('Planificación') }}</div>
                                <div class="ms-1">
                                    <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                ...
                @can('manage usuarios')
                    <x-dropdown align="left" width="56">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('usuarios.index')" :class="request()->routeIs('usuarios.*') ? 'bg-light text-primary' : ''">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <x-dropdown-link :href="route('roles.index')" :class="request()->routeIs('roles.*') ? 'bg-light text-primary' : ''">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <x-dropdown-link :href="route('permissions.index')" :class="request()->routeIs('permissions.*') ? 'bg-light text-primary' : ''">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 7a2 2 0 012 2m0 0a2 2 0 01-2 2m2-2h3m-3 0h-3m-2-4.5v9" />
                                </svg>
                                {{ __('Permisos') }}
                            </x-dropdown-link>
                        </x-slot>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-gray-200 hover:bg-blue-800 focus:outline-none focus:bg-blue-800 focus:text-gray-200 transition duration-150 ease-in-out">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @canany(['view planes', 'manage planes', 'view pnd', 'manage pnd', 'view objetivos_estrategicos', 'manage objetivos_estrategicos', 'view ods', 'manage ods'])
                <div class="px-3 py-2 mt-4">
                    <div class="text-xs font-semibold text-white/70 uppercase tracking-wide">{{ __('Planificación') }}
                    </div>
                </div>
            @endcanany
            ...
            @can('manage users')
                <div class="px-3 py-2 mt-4">
                    <div class="text-xs font-semibold text-white/70 uppercase tracking-wide">{{ __('Administración') }}
                    </div>
                </div>
                <x-responsive-nav-link :href="route('usuarios.index')" :active="request()->routeIs('usuarios.*')" class="pl-8">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
                    </svg>
