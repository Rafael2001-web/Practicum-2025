{{-- Create Modal --}}
<x-modal name="create-plan-modal" maxWidth="2xl">
    <div class="p-6">
        <div class="flex items-center justify-between mb-6">
            <h3 class="text-lg font-semibold text-primary">
                Crear Nuevo Plan
            </h3>
            <button onclick="closeModal('create-plan-modal')"
        ...
        <form id="create-plan-form" method="POST" action="{{ route('planes.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {{-- Entidad --}}
                <div>
                    <x-label for="entidad" value="Entidad" />
                    <x-input 
                        id="entidad" 
                        name="entidad" 
                        type="text" 
            ...
            <div class="flex justify-end space-x-3 pt-4">
                <x-secondary-button type="button" onclick="closeModal('create-plan-modal')">
                    Cancelar
                </x-secondary-button>
